# Sales Analysis with Python and Pandas 📊

This repository contains a hands-on Data Science project where I analyze a full year of sales data from an electronics store (12 months of data). 
...
* Converting data types and working with `datetime` objects.
* Grouping data using to answer business questions (e.g., What was the best month for sales?).
* Creating basic bar and line charts to visualize findings.
